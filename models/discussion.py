...
class Discussion(object):
	...
	def __init__(self, name):
		...
		self.add_users_to_discussion_xml = "<iq to='pubsub.mm.io' type='set' from='admin@mm.io'><pubsub xmlns='http://jabber.org/protocol/pubsub#owner'><subscriptions node='{}'><subscription jid='{}' node='{}' subscription='subscribed'/></subscriptions></pubsub></iq>"
